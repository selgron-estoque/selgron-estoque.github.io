# Stock360 — Backend de Sincronização (Supabase)

Esta pasta contém o banco (schema.sql) e a função que mantém o saldo sincronizado
com o Protheus. É o que falta para o Stock360 sair do protótipo (dados em
...
Diferente do saldo, o endereço é escrito direto pelo Stock360 no Supabase —
...
## 8. Como o front-end (Stock360) deve ler os dados, resumindo
